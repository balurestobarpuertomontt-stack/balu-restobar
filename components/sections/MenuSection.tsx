...
export default function MenuSection({ items, categories }: MenuSectionProps) {
  const [activeCategory, setActiveCategory] = useState<MenuCategory>("tablas");
    ...
    <section id="carta" className="py-28 px-6 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <SectionHeading
          ...
          title="Nuestro Menú"
          subtitle="Precios actualizados — listo para delivery y retiro en local"
        />
